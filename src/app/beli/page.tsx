        ...
        <div className="container px-5 py-24 mx-auto">
          <div>
            {listProduct.map((data: any, index) => (
              <div key={index + 1} className="lg:w-4/5 mx-auto flex flex-wrap">
                <Image width={400} height={400} src={data.img} alt="" />
                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 p-2">
                  ...
                  <p className="leading-relaxed text-sm w-80">
                    {data.description}
                  </p>
                  <div className="py-2">
